 ...
 */
public class PluginsDialog extends ExtendedTitleAreaDialog {

    private static final String HELP_ID = "com.archimatetool.help.PluginsDialog"; //$NON-NLS-1$
    ...
    public PluginsDialog(Shell parentShell) {
    ...
    protected void configureShell(Shell shell) {
        ...
        shell.setText(Messages.PluginsDialog_0);
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        setTitle(Messages.PluginsDialog_1);
        setMessage(Messages.PluginsDialog_2);
        ...
        column.getColumn().setText(Messages.PluginsDialog_3);
        
        column = new TableViewerColumn(viewer, SWT.NONE);
        layout.setColumnData(column.getColumn(), new ColumnWeightData(25, false));
        column.getColumn().setText(Messages.PluginsDialog_4);

        column = new TableViewerColumn(viewer, SWT.NONE);
        layout.setColumnData(column.getColumn(), new ColumnWeightData(25, false));
        column.getColumn().setText(Messages.PluginsDialog_5);
        
        column = new TableViewerColumn(viewer, SWT.NONE);
        layout.setColumnData(column.getColumn(), new ColumnWeightData(25, false));
        column.getColumn().setText(Messages.PluginsDialog_6);
    ...
    protected void buttonPressed(int buttonId) {
        ...
        switch(buttonId) {
            case INSTALL:
                InstallPluginHandler installHandler = new InstallPluginHandler();
            ...
            case UNINSTALL:
                ...
                UninstallPluginHandler uninstallHandler = new UninstallPluginHandler();
            ...
            case IDialogConstants.OK_ID:
                ...
                if(needsRestart) {
                    boolean restart = MessageDialog.openQuestion(getShell(),
                            Messages.PluginsDialog_7,
                            Messages.PluginsDialog_8);
                    if(restart) {
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        createButton(parent, INSTALL, Messages.PluginsDialog_9, false);
        createButton(parent, UNINSTALL, Messages.PluginsDialog_10, false).setEnabled(false);
        createButton(parent, IDialogConstants.OK_ID, Messages.PluginsDialog_11, true);
    }
